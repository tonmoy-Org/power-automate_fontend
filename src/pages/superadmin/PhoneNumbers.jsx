...
export const PhoneNumbers = () => {
  ...
  const paginatedGroups = groupedNumbers.slice(
    page * rowsPerPage,
  ...
  const statusSelectedCounts = {
    inactive: globalSelectedItems.filter((n) => n.is_active === "inactive")
      .length,
    running: globalSelectedItems.filter((n) => n.is_active === "running")
      .length,
    completed: globalSelectedItems.filter((n) => n.is_active === "completed")
      .length,
  };
  ...
  const handleFormatterSelectChange = (event) => {
    ...
    if (value.includes("select-all")) {
      ...
      setFormData((prev) => ({
        ...prev,
        password_formatter_ids:
          prev.password_formatter_ids.length === allIds.length ? [] : allIds,
      }));
    } else {
                    ...
                    passwordFormatters.map((f) => {
                      ...
                      return (
                        ...
                        >
                          <Checkbox
                            size="small"
                            checked={formData.password_formatter_ids.includes(
                              id,
                            )}
                          />
                          <ListItemText
